...
<html lang="en">
    ...
    >
        ...
        <a
                ...
                href="mariage.php"
                role="button"
                >Initier une procédures de mariage</a>
    </nav>
            ...
            <div class="content1">
                ...
                <div class="suiteDeFormulaire my-4">
                    ...
                    <div
                        ...
                        role="alert"
                    >
                        <strong>Vérifiez scrupuleusement les informations que vous saisissez avant de les soummettre</strong> </div>
                    
                    <div class="info-marie my-4">
                        
                        <form class="row g-3 needs-validation" method="post">
                           <!-- <div class="mari-form"> -->
                            <h3 class="text-primary">Information du marié</h3>
                            ...
                            <div class="col-md-4">
                                <label for="validationCustom03" class="form-label">Profession</label>
                                <input type="text" class="form-control" id="validationCustom03" name="professionEpoux" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <h5 class="py-3">Cate d'identité</h5>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <label for="validationCustom03" class="form-label">Profession</label>
                                <input type="text" class="form-control" id="validationCustom03" name="professionTemoinEpoux" required>
                                <div class="invalid-feedback">
                                  Please provide a profession.
                                </div>
                            </div>
                        ...
                        <!-- </div> -->
                           ...
                           <!-- <div class="mariee-form"> -->
                            <h3 class="pt-4 text-primary">Information de la mariée</h3>
                            ...
                            <div class="col-md-4">
                                <label for="validationCustom03" class="form-label">Profession</label>
                                <input type="text" class="form-control" id="validationCustom03" name="professionEpouse" required>
                                <div class="invalid-feedback">
                                  Please provide a profession.
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <label for="validationCustom03" class="form-label">Profession</label>
                                <input type="text" class="form-control" id="validationCustom03" name="professionTemoinEpouse" required>
                                <div class="invalid-feedback">
                                  Please provide a profession.
                                </div>
                            </div>
